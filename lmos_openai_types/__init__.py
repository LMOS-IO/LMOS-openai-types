...
#   filename:  <stdin>
#   timestamp: 2024-10-25T21:02:00+00:00
...
class CreateImageVariationRequest(BaseModel):
    ...
    """
    model: Optional[Union[Optional[str], Model7]] = Field(
        'dall-e-2', examples=['dall-e-2']
    )
    """
    The model to use for image generation. Only `dall-e-2` is supported at this time.
    ...
    The format in which the generated images are returned. Must be one of `url` or `b64_json`. URLs are only valid for 60 minutes after the image has been generated.
    """
    size: Optional[Size2] = Field('1024x1024', examples=['1024x1024'])
    """
    The size of the generated images. Must be one of `256x256`, `512x512`, or `1024x1024`.
    """
    user: Optional[str] = Field(None, examples=['user-1234'])
...
class CategoryAppliedInputTypes(BaseModel):
    ...
    """
    hate_threatening: List[HateThreateningEnum] = Field(..., alias='hate/threatening')
    """
    ...
    """
    illicit_violent: List[IllicitViolentEnum] = Field(..., alias='illicit/violent')
    """
    ...
    """
    self_harm_intent: List[SelfHarmIntentEnum] = Field(..., alias='self-harm/intent')
    """
    ...
    """
    sexual_minors: List[SexualMinor] = Field(..., alias='sexual/minors')
    """
    ...
    """
    violence_graphic: List[ViolenceGraphicEnum] = Field(..., alias='violence/graphic')
    """
...
class CreateThreadAndRunRequest(BaseModel):
    ...
    """
    model: Optional[Union[Optional[str], Model11]] = Field(None, examples=['gpt-4o'])
    """
    The ID of the [Model](/docs/api-reference/models) to be used to execute this run. If a value is provided here, it will override the model associated with the assistant. If not, the model associated with the assistant will be used.
    """
    instructions: Optional[str] = None
